...
bvc_model_choice = st.sidebar.selectbox("Select BVC Model", ["Hawkes BVC", "ACD BVC", "ACI BVC"])
...
ax.set_title(f"Price with EMA & Conditional VWAP - {bvc_model_choice}", fontsize=10)
